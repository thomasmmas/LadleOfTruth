 ...
 * @date 03/07/2023
 * @section CSC 331-001
 * @purpose A Scene for the Fighter to Choose a Path to travel.
 */
...
public class DDScene3ControllerFighter {
    ...
    public void leftButtonClicked(MouseEvent event) throws IOException {
        switchScene("Scenes/D&D_Scene_2_1_Fighter.fxml", event);
    }
    ...
    public void rightButtonClicked(MouseEvent event) throws IOException {
        switchScene("Scenes/D&D_Scene_3_1_Fighter.fxml", event);
    }
